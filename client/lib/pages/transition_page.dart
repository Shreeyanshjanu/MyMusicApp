...
import 'package:client/colors/color_pallete.dart'; // Import your color palette
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                // SVG Animation with ColorFilter (Method 2)
                SizedBox(
                  width: 200,
                  height: 200,
                  child: ColorFiltered(
                    colorFilter: ColorFilter.mode(
                      Colors.black.withOpacity(0.7), // Makes the image darker
                      BlendMode.srcATop,
                    ),
                ...
                // Title
                Text(
                  widget.title ?? "Hello and Welcome",
                ...
                // Description
                Text(
                  widget.description ?? "We're setting things up for you. This will only take a moment.",
                  style: TextStyle(
                    fontSize: 16,
                ...
                // Loading indicator with neumorphic container
                Container(
                  width: 80,
                  height: 80,
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: ColorPalette.darkShadowColor.withOpacity(
                          ColorPalette.darkShadowOpacity + 0.1,
                        ),
                        blurRadius: 15,
                        spreadRadius: 1,
                      ...
                      BoxShadow(
                        color: ColorPalette.lightShadowColor.withOpacity(
                          ColorPalette.lightShadowOpacity + 0.15,
                        ),
                        blurRadius: 15,
                        spreadRadius: 1,
                        offset: const Offset(-4, -4),
